...
class SdkLoader {
    private static final String LIB_ELEMENT_TYPE_NAME = (Build.VERSION.SDK_INT < 26 ? "dalvik.system.DexPathList$Element" : "dalvik.system.DexPathList$NativeLibraryElement");
