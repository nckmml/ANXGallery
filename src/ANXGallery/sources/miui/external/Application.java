...
public class Application extends android.app.Application implements SdkConstants {
    ...
    private boolean loadSdk() {
        try {
            if (SdkHelper.isMiuiSystem() || SdkLoader.load(SdkHelper.getApkPath((Context) null, "com.miui.core", "miui"), (String) null, SdkHelper.getLibPath((Context) null, "com.miui.core"), Application.class.getClassLoader())) {
                return true;
            }
