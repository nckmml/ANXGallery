...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    private void inflateInternal(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        while (eventType != 1 && (xmlPullParser.getDepth() >= depth || eventType != 3)) {
            if (eventType == 2) {
                ...
                if (nexExportFormat.TAG_FORMAT_PATH.equals(name)) {
    ...
    public boolean isStateful() {
        ...
        return this.mDelegateDrawable != null ? this.mDelegateDrawable.isStateful() : super.isStateful() || (vectorDrawableCompatState != null && (vectorDrawableCompatState.isStateful() || (this.mVectorState.mTint != null && this.mVectorState.mTint.isStateful())));
    }
