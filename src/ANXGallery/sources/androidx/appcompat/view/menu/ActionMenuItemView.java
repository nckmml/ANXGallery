...
public class ActionMenuItemView extends AppCompatTextView implements View.OnClickListener, MenuView.ItemView, ActionMenuView.ActionMenuChildView {
    ...
    private class ActionMenuItemForwardingListener extends ForwardingListener {
        ...
        public boolean onForwardingStarted() {
            ...
            return ActionMenuItemView.this.mItemInvoker != null && ActionMenuItemView.this.mItemInvoker.invokeItem(ActionMenuItemView.this.mItemData) && popup != null && popup.isShowing();
        }
    }
