...
public class DiffUtil {
    ...
    private static Snake diffPartial(Callback callback, int i, int i2, int i3, int i4, int[] iArr, int[] iArr2, int i5) {
        ...
        Arrays.fill(iArr4, i16 + i14, i17 + i14, i12);
        boolean z6 = i14 % 2 != 0;
        int i18 = 0;
        while (i18 <= i15) {
            int i19 = -i18;
            ...
            while (i20 <= i18) {
                if (i20 != i19) {
                    ...
                    i9 = iArr3[(i5 + i20) - z4] + z4;
                    z3 = z4;
                    i10 = i9 - i20;
                    while (i9 < i12 && i10 < i13 && callback2.areItemsTheSame(i + i9, i3 + i10)) {
                        i9++;
                        i10++;
                    }
                    i11 = i5 + i20;
                    iArr3[i11] = i9;
                    if (!z6 || i20 < (i14 - i18) + 1 || i20 > (i14 + i18) - 1 || iArr3[i11] < iArr4[i11]) {
                        i20 += 2;
                        z5 = false;
                        z4 = true;
                    } else {
                        ...
                        snake.x = iArr4[i11];
                        snake.y = snake.x - i20;
                        snake.size = iArr3[i11] - iArr4[i11];
                        snake.removal = z3;
                        snake.reverse = false;
                        return snake;
                    }
                }
                i9 = iArr3[i5 + i20 + (z4 ? 1 : 0)];
                z3 = z5;
                i10 = i9 - i20;
                while (i9 < i12) {
                    i9++;
            ...
            while (i22 <= i18) {
                ...
                if (i23 != i18 + i14) {
                    ...
                    int i25 = i5 + i23;
                    iArr4[i25] = i6;
                    if (!z6 || i23 < i19 || i23 > i18 || iArr3[i25] < iArr4[i25]) {
                        i22 += 2;
                        i12 = i8;
                        z7 = false;
                    } else {
                        Snake snake2 = new Snake();
                        snake2.x = iArr4[i25];
                        snake2.y = snake2.x - i23;
                        snake2.size = iArr3[i25] - iArr4[i25];
                        snake2.removal = z;
                        snake2.reverse = true;
                        return snake2;
                    }
