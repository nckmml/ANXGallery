...
public class RecyclerView extends ViewGroup implements NestedScrollingChild2 {
    ...
    class ViewFlinger implements Runnable {
        ...
        public void fling(int i, int i2) {
            ...
            this.mLastFlingY = 0;
            this.mLastFlingX = 0;
            this.mScroller.fling(0, 0, i, i2, Integer.MIN_VALUE, Reader.READ_DONE, Integer.MIN_VALUE, Reader.READ_DONE);
            postOnAnimation();
        }
        ...
        public void run() {
            ...
            if (overScroller.computeScrollOffset()) {
                ...
                if (RecyclerView.this.dispatchNestedPreScroll(i6, i7, iArr, (int[]) null, 1)) {
                    i6 -= iArr[0];
                    i7 -= iArr[1];
                }
                if (RecyclerView.this.mAdapter != null) {
    ...
    public boolean scrollByInternal(int i, int i2, MotionEvent motionEvent) {
        ...
        consumePendingUpdateOperations();
        if (this.mAdapter != null) {
            scrollStep(i8, i9, this.mScrollStepConsumed);
