...
public class NestedScrollView extends FrameLayout implements NestedScrollingChild2, NestedScrollingParent2 {
    ...
    public boolean arrowScroll(int i) {
        ...
        setDescendantFocusability(nexEngine.ExportHEVCHighTierLevel51);
        requestFocus();
    ...
    public boolean executeKeyEvent(KeyEvent keyEvent) {
        ...
        if (!canScroll) {
            ...
            View findNextFocus = FocusFinder.getInstance().findNextFocus(this, findFocus, BaiduSceneResult.VISA);
            return (findNextFocus == null || findNextFocus == this || !findNextFocus.requestFocus(BaiduSceneResult.VISA)) ? false : true;
            ...
            if (keyCode == 20) {
                return !keyEvent.isAltPressed() ? arrowScroll(BaiduSceneResult.VISA) : fullScroll(BaiduSceneResult.VISA);
            }
            if (keyCode != 62) {
                return false;
            }
    ...
    public void fling(int i) {
        if (getChildCount() > 0) {
            ...
            this.mScroller.fling(getScrollX(), getScrollY(), 0, i, 0, 0, Integer.MIN_VALUE, Reader.READ_DONE, 0, 0);
