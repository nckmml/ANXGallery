        ...
        if (this.mParent != null && ((ConstraintWidgetContainer) this.mParent).optimizeFor(2)) {
            ...
            for (int i4 = 0; i4 < this.mWidgetsCount; i4++) {
                ...
                if (this.mAllowsGoneWidget || constraintWidget.allowedInBarrier()) {
                    ...
                    ResolutionAnchor resolutionNode = i5 != 0 ? i5 != 1 ? i5 != 2 ? i5 != 3 ? null : constraintWidget.mBottom.getResolutionNode() : constraintWidget.mTop.getResolutionNode() : constraintWidget.mRight.getResolutionNode() : constraintWidget.mLeft.getResolutionNode();
