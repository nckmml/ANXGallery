        ...
        if (constraintWidget9 != null) {
            ...
            if (constraintWidget7.mListAnchors[i11].mTarget != null) {
                ...
                if (arrayList2 != null && (size = arrayList2.size()) > 1) {
                    float f4 = (!chainHead2.mHasUndefinedWeights || chainHead2.mHasComplexMatchWeights) ? f3 : (float) chainHead2.mWidgetsMatchCount;
                    float f5 = 0.0f;
                    float f6 = 0.0f;
                    ...
                    while (i5 < size) {
                        ...
                        float f7 = constraintWidget18.mWeight[i];
                        if (f7 < f5) {
                        ...
                        if (f7 == 0.0f) {
                            ...
                            if (constraintWidget17 != null) {
                                ...
                                createRow.createRowEqualMatchDimensions(f6, f4, f7, solverVariable6, solverVariable7, solverVariable8, solverVariable9);
                ...
                if (constraintWidget8 == null && (constraintWidget8 == constraintWidget9 || z9)) {
                    ...
                    if (!(solverVariable10 == null || solverVariable11 == null)) {
                        linearSystem.addCentering(constraintAnchor9.mSolverVariable, solverVariable10, constraintAnchor9.getMargin(), i == 0 ? constraintWidget16.mHorizontalBiasPercent : constraintWidget16.mVerticalBiasPercent, solverVariable11, constraintAnchor10.mSolverVariable, constraintAnchor10.getMargin(), 5);
                    }
