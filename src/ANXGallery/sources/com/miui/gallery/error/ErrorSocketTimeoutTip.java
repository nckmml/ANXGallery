...
public class ErrorSocketTimeoutTip extends ErrorTip {
    public ErrorSocketTimeoutTip(ErrorCode errorCode) {
        super(errorCode);
    }
    ...
    public CharSequence getActionStr(Context context) {
        return context.getResources().getString(R.string.error_socket_timeout_action);
    }

    public CharSequence getMessage(Context context) {
        return context.getResources().getString(R.string.error_socket_timeout_msg);
    }

    public CharSequence getTitle(Context context) {
        return context.getResources().getString(R.string.error_socket_timeout_tip);
    }
}
