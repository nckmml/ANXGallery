...
public class GalleryContract {
    ...
    public interface Album {
        public static final Long[] ALL_SYSTEM_ALBUM_SERVER_IDS = {-2147483647L, -2147483645L, -2147483644L, -2147483646L, 1L, 2L, -2147483642L, -2147483643L, 1000L, 4L};
        public static final int[] ALL_VIRTUAL_ALBUM_IDS = {Reader.READ_DONE, 2147483646, 2147483645, 2147483644, 2147483643, 2147483642};
        public static final Long[] LOCAL_SYSTEM_ALBUM_SERVER_IDS = {1L, 2L};
    ...
    public interface Common {
        ...
        public static final Uri URI_FILTER_SKY = GalleryContract.HTTPS_AUTHORITY_URI.buildUpon().appendPath("filter_sky").build();
