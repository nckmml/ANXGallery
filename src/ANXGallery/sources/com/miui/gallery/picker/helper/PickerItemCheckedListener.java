...
public class PickerItemCheckedListener {
    ...
    public void onItemChecked(Cursor cursor, View view) {
        ...
        if (this.mPicker.contains(sha1)) {
            ...
            ToastUtils.makeText(view.getContext(), (CharSequence) view.getContext().getString(R.string.picker_full_format, new Object[]{Integer.valueOf(this.mPicker.capacity())}));
        }
