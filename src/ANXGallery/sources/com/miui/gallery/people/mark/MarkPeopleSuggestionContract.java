...
public class MarkPeopleSuggestionContract {
    ...
    public static Bundle buildMarkInfoForMarkMyself(Context context) {
        ...
        bundle.putString("option_mark_relation", PeopleContactInfo.getRelationValue(PeopleContactInfo.Relation.myself));
    ...
    public static Uri buildMarkUriForMarkInfo(Bundle bundle) {
        return GalleryContract.Common.URI_PEOPLE_LIST_PAGE.buildUpon().appendQueryParameter("markMode", "true").appendQueryParameter("markRelation", bundle.getString("option_mark_relation")).build();
    }
}
