...
public class TrimView extends BaseMenuTopView {
    ...
    public View initContentView() {
        return inflate(this.mContext, R.layout.video_editor_trim_content_layout, (ViewGroup) null);
    }

    /* access modifiers changed from: protected */
    public View initTopView() {
        return inflate(this.mContext, R.layout.video_editor_trim_top_layout, (ViewGroup) null);
    }
