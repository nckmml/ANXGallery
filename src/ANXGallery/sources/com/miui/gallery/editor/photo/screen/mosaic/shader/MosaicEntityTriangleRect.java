...
public class MosaicEntityTriangleRect extends MosaicEntityRely {
    ...
    public MosaicShaderHolder generateShader(Bitmap bitmap, float f, Matrix matrix) {
        ...
        if (bitmap.getWidth() < round || bitmap.getHeight() < round) {
            return new MosaicShaderHolder(new BitmapShader(bitmap2, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP), MosaicEntity.TYPE.TRIANGLE_RECT);
        }
        ...
        return new MosaicShaderHolder(new BitmapShader(createBitmap, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP), MosaicEntity.TYPE.TRIANGLE_RECT);
    }
}
