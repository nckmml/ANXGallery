...
public class RawPhotoPickFragment extends CleanerPhotoPickFragment {
    ...
    public CleanerPhotoPickFragment.DeleteMessage getDeleteMessage() {
        return new CleanerPhotoPickFragment.DeleteMessage.Builder().setCleanerSubEvent("cleaner_raw_used").setReason(44).setDupType(0).build();
    }
    ...
    public View onInflateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.mActivity.getActionBar().setTitle(R.string.cleaner_raw_title);
        return onInflateView;
    }

    /* access modifiers changed from: protected */
    public void recordCancelSelectAllEvent() {
        GallerySamplingStatHelper.recordCountEvent("cleaner", "raw_select_all_cancel");
    }
}
