...
public final class NexAudioClip {
    ...
    public boolean equals(Object obj) {
        ...
        String str = this.mEnhancedAudioFilter;
        if (str != null) {
            if (str.equals(nexAudioClip.mEnhancedAudioFilter)) {
                return true;
            }
    ...
    public int hashCode() {
        ...
        int hashCode3 = (((((((((((((((((((hashCode2 + (iArr2 != null ? Arrays.hashCode(iArr2) : 0)) * 31) + this.mVoiceChanger) * 31) + this.mCompressor) * 31) + this.mPitchFactor) * 31) + this.mMusicEffector) * 31) + this.mProcessorStrength) * 31) + this.mBassStrength) * 31) + this.mPanLeft) * 31) + this.mPanRight) * 31) + this.mSpeedControl) * 31;
        String str = this.mEnhancedAudioFilter;
        if (str != null) {
            i = str.hashCode();
        }
