...
public class a {
    ...
    public static void a(nexFaceDetectionProvider nexfacedetectionprovider) {
        nexFaceDetectionProvider nexfacedetectionprovider2 = a;
    ...
    private void a(File file, boolean z, Context context) {
        ...
        if (file != null) {
            if (a != null) {
                ...
                nexFaceDetectionProvider nexfacedetectionprovider = a;
                if (nexfacedetectionprovider != null) {
                    nexfacedetectionprovider.init(file.getAbsolutePath(), context);
                    if (a != null) {
