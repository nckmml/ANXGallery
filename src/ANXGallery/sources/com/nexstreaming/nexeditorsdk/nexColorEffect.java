...
public final class nexColorEffect implements Cloneable {
    ...
    nexColorEffect(nexSaveDataFormat.nexColorEffectOf nexcoloreffectof) {
    ...
    public static int addCustomLUT(String str, byte[] bArr, int i, int i2, int i3) {
        ...
        a.getClass();
        try {
            return a.a(str, new b.C0005b(bArr, i, i2, i3));
        } catch (Exception e) {
            e.printStackTrace();
            return 0;
        }
    ...
    public static nexColorEffect getLutColorEffect(String str) {
        ...
        checkUpdate();
        for (nexColorEffect next : list) {
            if (next.getLUTId() == d.b()) {
                return next;
            }
        }
        return null;
    ...
    private static void resolveList(boolean z) {
        ...
        if (z) {
            ...
            if (a != null) {
                for (b.c next : a.f()) {
                    if (!next.c()) {
                        list.add(new nexColorEffect(next.a(), 0.0f, 0.0f, 0.0f, 0, next.b(), next.d(), next.e()));
                    }
                }
            }
        }
