...
public final class nexExportFormat {
    ...
    public final float getFloat(String str) {
        if (this.formats.containsKey(str)) {
            return Float.parseFloat(this.formats.get(str));
        }
        return 0.0f;
    }
    ...
    public final int getInteger(String str) {
        if (this.formats.containsKey(str)) {
            return Integer.parseInt(this.formats.get(str));
        }
        return 0;
    }
    ...
    public final long getLong(String str) {
        if (this.formats.containsKey(str)) {
            return Long.parseLong(this.formats.get(str));
        }
        return 0;
    }

    public final String getString(String str) {
        return this.formats.containsKey(str) ? this.formats.get(str) : "";
    }
