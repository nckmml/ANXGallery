...
final class ImageLoadingInfo {
    ...
    public ImageLoadingInfo(String str, ImageAware imageAware2, ImageSize imageSize, RectF rectF, String str2, DisplayImageOptions displayImageOptions, ImageLoadingListener imageLoadingListener, ImageLoadingProgressListener imageLoadingProgressListener, ReentrantLock reentrantLock) {
        this.uri = str;
