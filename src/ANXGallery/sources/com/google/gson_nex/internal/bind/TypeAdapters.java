...
public final class TypeAdapters {
    ...
    public static final TypeAdapter<BitSet> BIT_SET = new TypeAdapter<BitSet>() {
        ...
        public BitSet read(JsonReader jsonReader) throws IOException {
            ...
            while (peek != JsonToken.END_ARRAY) {
                int i2 = AnonymousClass32.$SwitchMap$com$google$gson_nex$stream$JsonToken[peek.ordinal()];
                boolean z = true;
                if (i2 != 1) {
                    if (i2 == 2) {
    ...
    public static TypeAdapterFactory newEnumTypeHierarchyFactory() {
        return new TypeAdapterFactory() {
            /* JADX WARNING: type inference failed for: r2v0, types: [com.google.gson_nex.reflect.TypeToken, com.google.gson_nex.reflect.TypeToken<T>] */
