                        ...
                        if (charAt2 < c2 && j3 < j4) {
                            ...
                            if (i7 != length) {
                                ...
                                if (Character.isSurrogatePair(charAt2, charAt3)) {
                                    ...
                                    long j13 = j12 + 1;
                                    c = 128;
                                    UnsafeUtil.putByte(bArr2, j12, (byte) (((codePoint >>> 12) & 63) | 128));
                                    long j14 = j13 + 1;
                                    UnsafeUtil.putByte(bArr2, j13, (byte) (((codePoint >>> 6) & 63) | 128));
                                    j2 = 1;
                                    j = j14 + 1;
                                    UnsafeUtil.putByte(bArr2, j14, (byte) ((codePoint & 63) | 128));
                                    i6 = i7;
                                } else {
                                    i6 = i7;
                                }
