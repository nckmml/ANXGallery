    ...
    public void mergeFrom(T t, byte[] bArr, int i, int i2, ArrayDecoders.Registers registers) throws IOException {
        ...
        while (i < i2) {
            ...
            if (i3 == WireFormat.MESSAGE_SET_ITEM_TAG) {
                    ...
                    if (tagFieldNumber != 2) {
                        if (tagFieldNumber == 3) {
                            if (generatedExtension != null) {
                                decodeVarint32 = ArrayDecoders.decodeMessageField(Protobuf.getInstance().schemaFor(generatedExtension.getMessageDefaultInstance().getClass()), bArr, decodeVarint32, i2, registers);
                ...
                if (findExtensionByNumber != null) {
                    i = ArrayDecoders.decodeMessageField(Protobuf.getInstance().schemaFor(findExtensionByNumber.getMessageDefaultInstance().getClass()), bArr, decodeVarint32, i2, registers);
