...
final class SchemaUtil {
    ...
    static int computeSizeFixed64List(int i, List<?> list, boolean z) {
        ...
        return z ? CodedOutputStream.computeTagSize(i) + CodedOutputStream.computeLengthDelimitedFieldSize(size * 8) : size * CodedOutputStream.computeFixed64Size(i, 0);
    }
        ...
        if (!(list instanceof RandomAccess)) {
            ...
            while (true) {
                ...
                while (it.hasNext()) {
                    ...
                    if (enumLiteMap.findValueByNumber(intValue) == null) {
                        ub = storeUnknownEnum(i, intValue, ub2, unknownFieldSchema);
                        it.remove();
                    }
                }
                break loop1;
            ...
            for (int i3 = 0; i3 < size; i3++) {
                ...
                if (enumLiteMap.findValueByNumber(intValue2) != null) {
                    ...
                    ub2 = storeUnknownEnum(i, intValue2, ub2, unknownFieldSchema);
                }
            }
            if (i2 != size) {
