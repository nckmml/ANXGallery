...
public abstract class CodedOutputStream extends ByteOutput {
    ...
    private static final class UnsafeDirectNioEncoder extends CodedOutputStream {
        ...
        public void write(byte b) throws IOException {
            ...
            throw new OutOfSpaceException(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Long.valueOf(j), Long.valueOf(this.limit), 1}));
        }
        ...
        public void writeUInt32NoTag(int i) throws IOException {
            ...
            while (true) {
                ...
                if (j3 >= this.limit) {
                    throw new OutOfSpaceException(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Long.valueOf(j3), Long.valueOf(this.limit), 1}));
                } else if ((i & -128) == 0) {
                    this.position = 1 + j3;
        ...
        public void writeUInt64NoTag(long j) throws IOException {
            ...
            while (true) {
                ...
                if (j4 >= this.limit) {
                    throw new OutOfSpaceException(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Long.valueOf(j4), Long.valueOf(this.limit), 1}));
                } else if ((j & -128) == 0) {
                    this.position = 1 + j4;
                    ...
                    this.position = j4 + 1;
                    UnsafeUtil.putByte(j4, (byte) ((((int) j) & BaiduSceneResult.BANK_CARD) | 128));
                    j >>>= 7;
                }
            }
        }
