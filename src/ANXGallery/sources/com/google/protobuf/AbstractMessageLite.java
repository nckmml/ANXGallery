...
public abstract class AbstractMessageLite<MessageType extends AbstractMessageLite<MessageType, BuilderType>, BuilderType extends Builder<MessageType, BuilderType>> implements MessageLite {
    ...
    /* access modifiers changed from: protected */
    public void mergeFromInternal(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
        try {
            Protobuf.getInstance().schemaFor(getClassInternal()).mergeFrom(this, CodedInputStreamReader.forCodedInput(codedInputStream), extensionRegistryLite);
        } catch (InvalidProtocolBufferException e) {
    ...
    /* access modifiers changed from: protected */
    public final void writeToInternal(CodedOutputStream codedOutputStream) throws IOException {
        Protobuf.getInstance().schemaFor(getClassInternal()).writeTo(this, CodedOutputStreamWriter.forCodedOutput(codedOutputStream));
    }
}
