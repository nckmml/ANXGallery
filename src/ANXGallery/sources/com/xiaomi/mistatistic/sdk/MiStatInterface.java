...
public abstract class MiStatInterface {
    ...
    private static boolean checkCategory(String str) {
        ...
        if (!str.startsWith("mistat_") && t.a(t.a.TYPE_CATEGORY, str)) {
            return true;
        }
    ...
    public static final void initialize(Context context, String str, String str2, String str3, final boolean z) throws MiStatException {
        if (!t.b()) {
            ...
            sInitialized = true;
            String b = j.b();
            Log.i(b, "The initialization consumes " + (System.currentTimeMillis() - currentTimeMillis) + " ms.");
        }
    }
    ...
    public static final void recordCalculateEvent(String str, String str2, long j, Map<String, String> map) {
        if (!t.b()) {
            ...
            if (map == null || map.size() <= 15) {
                ...
                LocalEventRecorder.insertEvent(new com.xiaomi.mistatistic.sdk.data.b(str, str2, j, map));
                a.a();
                return;
            }
    ...
    public static final void setUploadPolicy(int i, long j) {
        if (!t.b()) {
            ...
            if (i != 0 && i != 1) {
                ...
                Log.e(j.b(), String.format("setUploadPolicy: value(interval of UPLOAD_POLICY_INTERVAL) should be set between %d and %d.", new Object[]{90000L, 86400000L}));
            } else if (i != 1 || (j <= 30720 && j >= 3072)) {
                s.a().a(i, j);
            } else {
                Log.e(j.b(), String.format("setUploadPolicy: value(size of UPLOAD_POLICY_BATCH) should be set between %d and %d.", new Object[]{3072L, 30720L}));
            }
        }
    }
}
