...
public class XmPushActionSubscriptionResult implements Serializable, Cloneable, TBase<XmPushActionSubscriptionResult, Object> {
    ...
    public int compareTo(XmPushActionSubscriptionResult xmPushActionSubscriptionResult) {
        ...
        int compareTo10 = Boolean.valueOf(isSetDebug()).compareTo(Boolean.valueOf(xmPushActionSubscriptionResult.isSetDebug()));
        if (compareTo10 != 0) {
            return compareTo10;
        }
        if (isSetDebug() && (compareTo9 = TBaseHelper.compareTo(this.debug, xmPushActionSubscriptionResult.debug)) != 0) {
            return compareTo9;
        }
        int compareTo11 = Boolean.valueOf(isSetTarget()).compareTo(Boolean.valueOf(xmPushActionSubscriptionResult.isSetTarget()));
        if (compareTo11 != 0) {
            return compareTo11;
        }
        if (isSetTarget() && (compareTo8 = TBaseHelper.compareTo((Comparable) this.target, (Comparable) xmPushActionSubscriptionResult.target)) != 0) {
            return compareTo8;
        }
        int compareTo12 = Boolean.valueOf(isSetId()).compareTo(Boolean.valueOf(xmPushActionSubscriptionResult.isSetId()));
        if (compareTo12 != 0) {
            return compareTo12;
        }
        if (isSetId() && (compareTo7 = TBaseHelper.compareTo(this.id, xmPushActionSubscriptionResult.id)) != 0) {
            return compareTo7;
        }
        int compareTo13 = Boolean.valueOf(isSetAppId()).compareTo(Boolean.valueOf(xmPushActionSubscriptionResult.isSetAppId()));
        if (compareTo13 != 0) {
            return compareTo13;
        }
        if (isSetAppId() && (compareTo6 = TBaseHelper.compareTo(this.appId, xmPushActionSubscriptionResult.appId)) != 0) {
            return compareTo6;
        }
        int compareTo14 = Boolean.valueOf(isSetErrorCode()).compareTo(Boolean.valueOf(xmPushActionSubscriptionResult.isSetErrorCode()));
        if (compareTo14 != 0) {
            return compareTo14;
        }
        ...
        int compareTo15 = Boolean.valueOf(isSetReason()).compareTo(Boolean.valueOf(xmPushActionSubscriptionResult.isSetReason()));
        if (compareTo15 != 0) {
            return compareTo15;
        }
        ...
        int compareTo16 = Boolean.valueOf(isSetTopic()).compareTo(Boolean.valueOf(xmPushActionSubscriptionResult.isSetTopic()));
        if (compareTo16 != 0) {
            return compareTo16;
        }
        ...
        int compareTo17 = Boolean.valueOf(isSetPackageName()).compareTo(Boolean.valueOf(xmPushActionSubscriptionResult.isSetPackageName()));
        if (compareTo17 != 0) {
            return compareTo17;
        }
        ...
        int compareTo18 = Boolean.valueOf(isSetCategory()).compareTo(Boolean.valueOf(xmPushActionSubscriptionResult.isSetCategory()));
        if (compareTo18 != 0) {
            return compareTo18;
        }
    ...
    public boolean equals(XmPushActionSubscriptionResult xmPushActionSubscriptionResult) {
        ...
        if (isSetCategory || isSetCategory2) {
            return isSetCategory && isSetCategory2 && this.category.equals(xmPushActionSubscriptionResult.category);
        }
        return true;
    }
