...
.method protected getRemoteFallbackJSON(Ljava/util/ArrayList;Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/String;
    ...
    invoke-static {v2}, Lcom/xiaomi/network/HostManager;->obfuscate(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    const-string v3, "conpt"

    invoke-direct {p2, v3, v2}, Lcom/xiaomi/channel/commonutils/network/BasicNameValuePair;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p1, p3}, Lcom/xiaomi/channel/commonutils/string/XMStringUtils;->join(Ljava/util/Collection;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p2}, Lcom/xiaomi/push/service/AppRegionStorage;->getCountryCode()Ljava/lang/String;

    move-result-object p2

    const-string p3, "countrycode"

    invoke-direct {p1, p3, p2}, Lcom/xiaomi/channel/commonutils/network/BasicNameValuePair;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v2, "http://%1$s/gslb/?ver=4.0"
    ...
    sget-object p4, Lcom/xiaomi/network/HostManager;->sReservedHosts:Ljava/util/Map;
    ...
    invoke-virtual {p1, p3}, Lcom/xiaomi/network/Fallback;->getHosts(Z)Ljava/util/ArrayList;
    ...
    const-string v4, "http://%1$s/gslb/?ver=4.0"
