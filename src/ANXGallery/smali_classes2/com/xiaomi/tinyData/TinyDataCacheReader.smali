...
.method private static extractTinyData(Landroid/content/Context;Lcom/xiaomi/tinyData/TinyDataUploader;)V
    ...
    sget-boolean v2, Lcom/xiaomi/tinyData/TinyDataCacheReader;->mTinyDataJobIsRunning:Z

    if-nez v2, :cond_4

    const/4 v2, 0x1

    sput-boolean v2, Lcom/xiaomi/tinyData/TinyDataCacheReader;->mTinyDataJobIsRunning:Z
    ...
    :cond_2
    invoke-static {p0, p1, v2, v3}, Lcom/xiaomi/tinyData/TinyDataCacheReader;->readTinyDataFromFile(Landroid/content/Context;Lcom/xiaomi/tinyData/TinyDataUploader;Ljava/io/File;[B)V
...
.method private static readTinyDataFromFile(Landroid/content/Context;Lcom/xiaomi/tinyData/TinyDataUploader;Ljava/io/File;[B)V
    ...
    :cond_4
    invoke-static {p3, v10}, Lcom/xiaomi/channel/commonutils/android/DataCryptUtils;->mipushDecrypt([B[B)[B
    ...
    :cond_5
    new-instance v10, Lcom/xiaomi/xmpush/thrift/ClientUploadDataItem;

    invoke-direct {v10}, Lcom/xiaomi/xmpush/thrift/ClientUploadDataItem;-><init>()V

    invoke-static {v10, v7}, Lcom/xiaomi/xmpush/thrift/XmPushThriftSerializeUtils;->convertByteArrayToThriftObject(Lorg/apache/thrift/TBase;[B)V
