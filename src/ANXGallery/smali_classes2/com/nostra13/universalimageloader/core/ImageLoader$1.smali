...
.method public run()V
    ...
    iget-object v2, p0, Lcom/nostra13/universalimageloader/core/ImageLoader$1;->val$finalOptions:Lcom/nostra13/universalimageloader/core/DisplayImageOptions;

    iget-object v3, p0, Lcom/nostra13/universalimageloader/core/ImageLoader$1;->this$0:Lcom/nostra13/universalimageloader/core/ImageLoader;

    invoke-static {v3}, Lcom/nostra13/universalimageloader/core/ImageLoader;->access$100(Lcom/nostra13/universalimageloader/core/ImageLoader;)Lcom/nostra13/universalimageloader/core/ImageLoaderConfiguration;

    move-result-object v3

    iget-object v3, v3, Lcom/nostra13/universalimageloader/core/ImageLoaderConfiguration;->resources:Landroid/content/res/Resources;

    invoke-virtual {v2, v3}, Lcom/nostra13/universalimageloader/core/DisplayImageOptions;->getImageForEmptyUri(Landroid/content/res/Resources;)Landroid/graphics/drawable/Drawable;

    move-result-object v2

    invoke-interface {v0, v2}, Lcom/nostra13/universalimageloader/core/imageaware/ImageAware;->setImageDrawable(Landroid/graphics/drawable/Drawable;)Z
    ...
    iget-object v2, p0, Lcom/nostra13/universalimageloader/core/ImageLoader$1;->val$uri:Ljava/lang/String;

    iget-object v3, p0, Lcom/nostra13/universalimageloader/core/ImageLoader$1;->val$imageAware:Lcom/nostra13/universalimageloader/core/imageaware/ImageAware;

    invoke-interface {v3}, Lcom/nostra13/universalimageloader/core/imageaware/ImageAware;->getWrappedView()Landroid/view/View;

    move-result-object v3

    invoke-interface {v0, v2, v3, v1}, Lcom/nostra13/universalimageloader/core/listener/ImageLoadingListener;->onLoadingComplete(Ljava/lang/String;Landroid/view/View;Landroid/graphics/Bitmap;)V
