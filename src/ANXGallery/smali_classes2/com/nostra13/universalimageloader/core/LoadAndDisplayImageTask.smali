...
.method public constructor <init>(Lcom/nostra13/universalimageloader/core/ImageLoaderEngine;Lcom/nostra13/universalimageloader/core/ImageLoadingInfo;Landroid/os/Handler;)V
    ...
    iput-object p1, p0, Lcom/nostra13/universalimageloader/core/LoadAndDisplayImageTask;->displayer:Lcom/nostra13/universalimageloader/core/display/BitmapDisplayer;
...
.method static synthetic access$100(Lcom/nostra13/universalimageloader/core/LoadAndDisplayImageTask;)Lcom/nostra13/universalimageloader/core/display/BitmapDisplayer;
    .locals 0

    iget-object p0, p0, Lcom/nostra13/universalimageloader/core/LoadAndDisplayImageTask;->displayer:Lcom/nostra13/universalimageloader/core/display/BitmapDisplayer;
...
.method private fireCancelEvent()V
    ...
    invoke-static {v0, v2, v1, v3}, Lcom/nostra13/universalimageloader/core/LoadAndDisplayImageTask;->runTask(Ljava/lang/Runnable;ZLandroid/os/Handler;Lcom/nostra13/universalimageloader/core/ImageLoaderEngine;)V
...
.method private fireFailEvent(Lcom/nostra13/universalimageloader/core/assist/FailReason$FailType;Ljava/lang/Throwable;)V
    ...
    const-string v1, "Loading image failed, fail Type %s, uri %s"

    invoke-static {p2, v1, v0}, Lcom/nostra13/universalimageloader/utils/L;->e(Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private tryLoadBitmap()Landroid/graphics/Bitmap;
    ...
    .catch Lcom/nostra13/universalimageloader/core/LoadAndDisplayImageTask$TaskCancelledException; {:try_start_0 .. :try_end_0} :catch_9
    ...
    .catch Lcom/nostra13/universalimageloader/core/LoadAndDisplayImageTask$TaskCancelledException; {:try_start_1 .. :try_end_1} :catch_9
    ...
    :goto_5
    invoke-direct {p0, v2}, Lcom/nostra13/universalimageloader/core/LoadAndDisplayImageTask;->recordDecodeError(Ljava/lang/Throwable;)V
...
.method public run()V
    ...
    invoke-virtual {v0}, Lcom/nostra13/universalimageloader/core/DisplayImageOptions;->isSerialByUri()Z
    ...
    iget-object v1, v1, Lcom/nostra13/universalimageloader/core/ImageLoadingInfo;->loadFromUriLock:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    invoke-virtual {v4}, Lcom/nostra13/universalimageloader/core/DisplayImageOptions;->isCacheInSubMemory()Z
    ...
    invoke-interface {v4, v6}, Lcom/nostra13/universalimageloader/cache/memory/MemoryCache;->get(Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    iget-object v6, v6, Lcom/nostra13/universalimageloader/core/ImageLoaderConfiguration;->subMemoryCache:Lcom/nostra13/universalimageloader/cache/memory/MemoryCache;
    ...
    invoke-virtual {v7}, Lcom/miui/gallery/imageloader/GalleryImageLoaderCache;->getMicroThumbCache()Lcom/miui/gallery/imageloader/GalleryImageLoaderCache$IMicroThumbCache;
    ...
    invoke-virtual {v4}, Lcom/nostra13/universalimageloader/core/DisplayImageOptions;->isBitmapReused()Z
    ...
    iget-object v9, p0, Lcom/nostra13/universalimageloader/core/LoadAndDisplayImageTask;->imageAware:Lcom/nostra13/universalimageloader/core/imageaware/ImageAware;

    invoke-interface {v9}, Lcom/nostra13/universalimageloader/core/imageaware/ImageAware;->getBitmap()Landroid/graphics/Bitmap;

    move-result-object v9

    invoke-virtual {v4, v8, v9}, Lcom/nostra13/universalimageloader/core/ImageLoader;->isOnImageLoadingBitmap(Lcom/nostra13/universalimageloader/core/DisplayImageOptions;Landroid/graphics/Bitmap;)Z

    move-result v4

    if-nez v4, :cond_b

    iget-object v4, p0, Lcom/nostra13/universalimageloader/core/LoadAndDisplayImageTask;->imageAware:Lcom/nostra13/universalimageloader/core/imageaware/ImageAware;

    invoke-interface {v4}, Lcom/nostra13/universalimageloader/core/imageaware/ImageAware;->getBitmap()Landroid/graphics/Bitmap;
    ...
    invoke-interface {v7, v4, v5}, Lcom/miui/gallery/imageloader/GalleryImageLoaderCache$IMicroThumbCache;->getCenterCropBitmap(Ljava/lang/String;Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v6, v5}, Lcom/nostra13/universalimageloader/utils/L;->d(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-interface {v5, v7, v4}, Lcom/nostra13/universalimageloader/cache/memory/MemoryCache;->put(Ljava/lang/String;Landroid/graphics/Bitmap;)Z

    :cond_d
    iget-object v5, p0, Lcom/nostra13/universalimageloader/core/LoadAndDisplayImageTask;->options:Lcom/nostra13/universalimageloader/core/DisplayImageOptions;

    invoke-virtual {v5}, Lcom/nostra13/universalimageloader/core/DisplayImageOptions;->isCacheInSubMemory()Z
    ...
    iget-object v5, v5, Lcom/nostra13/universalimageloader/core/ImageLoaderConfiguration;->subMemoryCache:Lcom/nostra13/universalimageloader/cache/memory/MemoryCache;
    ...
    invoke-virtual {v5}, Lcom/nostra13/universalimageloader/core/DisplayImageOptions;->isLoadFromThumbnailCache()Z
    ...
    invoke-static {v5, v7}, Lcom/nostra13/universalimageloader/utils/L;->d(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-interface {v5, v4}, Lcom/nostra13/universalimageloader/core/process/BitmapProcessor;->process(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v5, v7}, Lcom/nostra13/universalimageloader/utils/L;->e(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-interface {v5, v6, v4}, Lcom/nostra13/universalimageloader/cache/memory/MemoryCache;->put(Ljava/lang/String;Landroid/graphics/Bitmap;)Z
    ...
    invoke-virtual {v5}, Lcom/nostra13/universalimageloader/core/DisplayImageOptions;->isCacheThumbnail()Z
    ...
    invoke-virtual {v5}, Lcom/nostra13/universalimageloader/core/DisplayImageOptions;->isDelayCacheThumbnail()Z
    ...
    :cond_17
    invoke-direct {p0, v4}, Lcom/nostra13/universalimageloader/core/LoadAndDisplayImageTask;->cacheImageThumbnail(Landroid/graphics/Bitmap;)V
    ...
    invoke-static {v6, v2}, Lcom/nostra13/universalimageloader/utils/L;->e(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    iget-object v3, p0, Lcom/nostra13/universalimageloader/core/LoadAndDisplayImageTask;->loadedFrom:Lcom/nostra13/universalimageloader/core/assist/LoadedFrom;

    invoke-direct {v0, v4, v1, v2, v3}, Lcom/nostra13/universalimageloader/core/DisplayBitmapTask;-><init>(Landroid/graphics/Bitmap;Lcom/nostra13/universalimageloader/core/ImageLoadingInfo;Lcom/nostra13/universalimageloader/core/ImageLoaderEngine;Lcom/nostra13/universalimageloader/core/assist/LoadedFrom;)V
