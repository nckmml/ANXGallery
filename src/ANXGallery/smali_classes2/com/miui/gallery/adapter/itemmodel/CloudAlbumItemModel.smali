...
.method public bridge synthetic bindData(Lcom/miui/epoxy/EpoxyViewHolder;Ljava/util/List;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/miui/gallery/adapter/itemmodel/CloudAlbumItemModel;->bindData(Lcom/miui/gallery/adapter/itemmodel/CloudAlbumItemModel$CloudAlbumVH;Ljava/util/List;)V

    return-void
.end method

.method public bindData(Lcom/miui/gallery/adapter/itemmodel/CloudAlbumItemModel$CloudAlbumVH;Ljava/util/List;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0}, Lcom/miui/gallery/adapter/itemmodel/CloudAlbumItemModel;->getItemData()Ljava/lang/Object;

    move-result-object p2

    check-cast p2, Lcom/miui/gallery/ui/album/cloudalbum/viewbean/CloudAlbumItemViewBean;

    invoke-static {p1}, Lcom/miui/gallery/adapter/itemmodel/CloudAlbumItemModel$CloudAlbumVH;->access$000(Lcom/miui/gallery/adapter/itemmodel/CloudAlbumItemModel$CloudAlbumVH;)Landroid/widget/TextView;

    move-result-object v0

    invoke-virtual {p2}, Lcom/miui/gallery/ui/album/cloudalbum/viewbean/CloudAlbumItemViewBean;->getAlbumName()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p0, v0, v1}, Lcom/miui/gallery/adapter/itemmodel/CloudAlbumItemModel;->setText(Landroid/widget/TextView;Ljava/lang/String;)V

    invoke-static {p1}, Lcom/miui/gallery/adapter/itemmodel/CloudAlbumItemModel$CloudAlbumVH;->access$100(Lcom/miui/gallery/adapter/itemmodel/CloudAlbumItemModel$CloudAlbumVH;)Landroid/widget/TextView;

    move-result-object v0

    invoke-virtual {p2}, Lcom/miui/gallery/ui/album/cloudalbum/viewbean/CloudAlbumItemViewBean;->getPhotoNumberText()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p0, v0, v1}, Lcom/miui/gallery/adapter/itemmodel/CloudAlbumItemModel;->setText(Landroid/widget/TextView;Ljava/lang/String;)V

    iget-object v0, p1, Lcom/miui/gallery/adapter/itemmodel/CloudAlbumItemModel$CloudAlbumVH;->mCbBackup:Lmiui/widget/SlidingButton;

    invoke-virtual {p2}, Lcom/miui/gallery/ui/album/cloudalbum/viewbean/CloudAlbumItemViewBean;->isBackup()Z
    ...
    invoke-static {p1}, Lcom/miui/gallery/adapter/itemmodel/CloudAlbumItemModel$CloudAlbumVH;->access$200(Lcom/miui/gallery/adapter/itemmodel/CloudAlbumItemModel$CloudAlbumVH;)Landroid/widget/ImageView;

    move-result-object p1

    invoke-virtual {p2}, Lcom/miui/gallery/ui/album/cloudalbum/viewbean/CloudAlbumItemViewBean;->getAlbumCoverPath()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p2}, Lcom/miui/gallery/ui/album/cloudalbum/viewbean/CloudAlbumItemViewBean;->getAlbumCover()Landroid/net/Uri;
    ...
    invoke-virtual {p2}, Lcom/miui/gallery/ui/album/cloudalbum/viewbean/CloudAlbumItemViewBean;->getCoverSize()J
    ...
    invoke-virtual {p0, p1, v0, v1, p2}, Lcom/miui/gallery/adapter/itemmodel/CloudAlbumItemModel;->bindImage(Landroid/widget/ImageView;Ljava/lang/String;Landroid/net/Uri;Lcom/nostra13/universalimageloader/core/DisplayImageOptions;)V
