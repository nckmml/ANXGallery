...
.method public handle(Ljava/io/FileOutputStream;)Ljava/lang/Boolean;
    ...
    :try_start_0
    iget-object v3, p0, Lcom/miui/gallery/util/CryptoUtil$4;->val$inputStream:Ljava/io/FileInputStream;
    ...
    iget-object v6, p0, Lcom/miui/gallery/util/CryptoUtil$4;->val$inputStream:Ljava/io/FileInputStream;
    ...
    const-string v1, "read encrypted header bytes error"
    ...
    :cond_1
    iget-object v6, p0, Lcom/miui/gallery/util/CryptoUtil$4;->val$key:[B

    invoke-static {v5, v6}, Lcom/miui/gallery/util/CryptoUtil;->access$100([B[B)[B
    ...
    const-string v1, "Encrypted file is malformed."
    ...
    invoke-virtual {p1, v8, v9}, Ljava/nio/channels/FileChannel;->truncate(J)Ljava/nio/channels/FileChannel;
    ...
    const-string v1, "write decrypted header bytes error"
    ...
    :goto_2
    :try_start_4
    const-string v1, "decrypt header bytes error"
