...
.field private mInternalOnSpecialTypeEnterListener:Lcom/miui/gallery/ui/PhotoPageItem$OnSpecialTypeEnterListener;
...
.field private mOnSpecialTypeEnterListener:Lcom/miui/gallery/ui/PhotoPagerHelper$OnSpecialTypeEnterListener;
...
.field private mSpecialTypeEnterViewCache:Lcom/miui/gallery/util/RecyclerLayoutCache;
...
.method static synthetic access$700(Lcom/miui/gallery/ui/PhotoPagerHelper;)Lcom/miui/gallery/ui/PhotoPagerHelper$OnSpecialTypeEnterListener;
    .locals 0
...
.method public getCorrectPosition(IZ)I
    ...
    iget-object p2, p0, Lcom/miui/gallery/ui/PhotoPagerHelper;->mViewPager:Lcom/miui/gallery/widget/ViewPager;

    invoke-virtual {p2}, Lcom/miui/gallery/widget/ViewPager;->getAdapter()Lcom/miui/gallery/widget/PagerAdapter;
...
.method public setPageSettled(I)V
    ...
    iget-object v5, p0, Lcom/miui/gallery/ui/PhotoPagerHelper;->mSpecialTypeEnterViewCache:Lcom/miui/gallery/util/RecyclerLayoutCache;

    invoke-virtual {v4, v5}, Lcom/miui/gallery/ui/PhotoPageItem;->setSpecialTypeEnterViewCache(Lcom/miui/gallery/util/RecyclerLayoutCache;)V

    if-eq v4, v1, :cond_1

    iget-object v5, p0, Lcom/miui/gallery/ui/PhotoPagerHelper;->mViewPager:Lcom/miui/gallery/widget/ViewPager;

    invoke-virtual {v5, v3}, Lcom/miui/gallery/widget/ViewPager;->getPositionByNativeIndex(I)I

    move-result v5

    sub-int/2addr v5, p1

    invoke-virtual {v4, v2, v5}, Lcom/miui/gallery/ui/PhotoPageItem;->onUnSelected(ZI)V

    const/4 v5, 0x0

    invoke-virtual {v4, v5}, Lcom/miui/gallery/ui/PhotoPageItem;->setOnViewTapListener(Luk/co/senab/photoview/PhotoViewAttacher$OnViewTapListener;)V

    invoke-virtual {v4, v5}, Lcom/miui/gallery/ui/PhotoPageItem;->setCloudImageLoadingListener(Lcom/miui/gallery/util/uil/CloudImageLoadingListener;)V

    invoke-virtual {v4, v5}, Lcom/miui/gallery/ui/PhotoPageItem;->setOnExitListener(Luk/co/senab/photoview/PhotoViewAttacher$OnExitListener;)V

    invoke-virtual {v4, v5}, Lcom/miui/gallery/ui/PhotoPageItem;->setOnScaleChangeListener(Luk/co/senab/photoview/PhotoViewAttacher$OnScaleChangeListener;)V

    iget-object v6, p0, Lcom/miui/gallery/ui/PhotoPagerHelper;->mInternalMatrixListener:Luk/co/senab/photoview/PhotoViewAttacher$OnMatrixChangedListener;

    invoke-virtual {v4, v6}, Lcom/miui/gallery/ui/PhotoPageItem;->removeOnMatrixChangeListener(Luk/co/senab/photoview/PhotoViewAttacher$OnMatrixChangedListener;)V

    invoke-virtual {v4, v5}, Lcom/miui/gallery/ui/PhotoPageItem;->setOnBackgroundAlphaChangedListener(Luk/co/senab/photoview/PhotoViewAttacher$OnBackgroundAlphaChangedListener;)V

    invoke-virtual {v4, v5}, Lcom/miui/gallery/ui/PhotoPageItem;->setTrimMemoryCallback(Lcom/miui/gallery/util/photoview/TrimMemoryCallback;)V

    invoke-virtual {v4, v5}, Lcom/miui/gallery/ui/PhotoPageItem;->setOnSpecialTypeEnterListener(Lcom/miui/gallery/ui/PhotoPageItem$OnSpecialTypeEnterListener;)V

    goto :goto_1

    :cond_1
    iget-object v5, p0, Lcom/miui/gallery/ui/PhotoPagerHelper;->mInternalTapListener:Luk/co/senab/photoview/PhotoViewAttacher$OnViewTapListener;

    invoke-virtual {v4, v5}, Lcom/miui/gallery/ui/PhotoPageItem;->setOnViewTapListener(Luk/co/senab/photoview/PhotoViewAttacher$OnViewTapListener;)V

    iget-object v5, p0, Lcom/miui/gallery/ui/PhotoPagerHelper;->mInternalImageLoadingListener:Lcom/miui/gallery/util/uil/CloudImageLoadingListener;

    invoke-virtual {v4, v5}, Lcom/miui/gallery/ui/PhotoPageItem;->setCloudImageLoadingListener(Lcom/miui/gallery/util/uil/CloudImageLoadingListener;)V

    iget-object v5, p0, Lcom/miui/gallery/ui/PhotoPagerHelper;->mInternalExitListener:Luk/co/senab/photoview/PhotoViewAttacher$OnExitListener;

    invoke-virtual {v4, v5}, Lcom/miui/gallery/ui/PhotoPageItem;->setOnExitListener(Luk/co/senab/photoview/PhotoViewAttacher$OnExitListener;)V

    iget-object v5, p0, Lcom/miui/gallery/ui/PhotoPagerHelper;->mInternalScaleListener:Luk/co/senab/photoview/PhotoViewAttacher$OnScaleChangeListener;
    ...
    invoke-virtual {v4, v5}, Lcom/miui/gallery/ui/PhotoPageItem;->addOnMatrixChangeListener(Luk/co/senab/photoview/PhotoViewAttacher$OnMatrixChangedListener;)V

    iget-object v5, p0, Lcom/miui/gallery/ui/PhotoPagerHelper;->mInternalAlphaChangedListener:Luk/co/senab/photoview/PhotoViewAttacher$OnBackgroundAlphaChangedListener;

    invoke-virtual {v4, v5}, Lcom/miui/gallery/ui/PhotoPageItem;->setOnBackgroundAlphaChangedListener(Luk/co/senab/photoview/PhotoViewAttacher$OnBackgroundAlphaChangedListener;)V

    iget-object v5, p0, Lcom/miui/gallery/ui/PhotoPagerHelper;->mInternalTrimMemoryCallback:Lcom/miui/gallery/util/photoview/TrimMemoryCallback;

    invoke-virtual {v4, v5}, Lcom/miui/gallery/ui/PhotoPageItem;->setTrimMemoryCallback(Lcom/miui/gallery/util/photoview/TrimMemoryCallback;)V

    iget-object v5, p0, Lcom/miui/gallery/ui/PhotoPagerHelper;->mInternalOnSpecialTypeEnterListener:Lcom/miui/gallery/ui/PhotoPageItem$OnSpecialTypeEnterListener;

    invoke-virtual {v4, v5}, Lcom/miui/gallery/ui/PhotoPageItem;->setOnSpecialTypeEnterListener(Lcom/miui/gallery/ui/PhotoPageItem$OnSpecialTypeEnterListener;)V

    invoke-virtual {v4, v2}, Lcom/miui/gallery/ui/PhotoPageItem;->onSelected(Z)V

    :goto_1
    iget-object v5, p0, Lcom/miui/gallery/ui/PhotoPagerHelper;->mInternalOnImageLoadFinishListener:Lcom/miui/gallery/ui/PhotoPageItem$OnImageLoadFinishListener;

    invoke-virtual {v4, v5}, Lcom/miui/gallery/ui/PhotoPageItem;->setOnImageLoadFinishListener(Lcom/miui/gallery/ui/PhotoPageItem$OnImageLoadFinishListener;)V
