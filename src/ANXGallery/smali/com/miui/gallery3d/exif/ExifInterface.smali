...
.method public constructor <init>()V
    ...
    iput-object v1, p0, Lcom/miui/gallery3d/exif/ExifInterface;->mGPSTimeStampCalendar:Ljava/util/Calendar;

    const/4 v1, 0x0

    iput-object v1, p0, Lcom/miui/gallery3d/exif/ExifInterface;->mTagInfo:Landroid/util/SparseIntArray;
...
.method public addGpsDateTimeStampTag(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :cond_2
    sget p2, Lcom/miui/gallery3d/exif/ExifInterface;->TAG_GPS_TIME_STAMP:I
    ...
    invoke-direct {v2, v7, v8, v5, v6}, Lcom/miui/gallery3d/exif/Rational;-><init>(JJ)V
    ...
    invoke-virtual {p0, p2, v0}, Lcom/miui/gallery3d/exif/ExifInterface;->buildTag(ILjava/lang/Object;)Lcom/miui/gallery3d/exif/ExifTag;
...
.method public addSubSecTimeStampTag(J)Z
    .locals 1
    ...
    sget v0, Lcom/miui/gallery3d/exif/ExifInterface;->TAG_SUB_SEC_TIME:I
...
.method public forceRewriteExif(Ljava/lang/String;Ljava/util/Collection;)V
    ...
    :try_end_1
    .catch Lcom/miui/gallery3d/exif/ExifInvalidFormatException; {:try_start_1 .. :try_end_1} :catch_a
    ...
    invoke-direct {p0, v3, v4}, Lcom/miui/gallery3d/exif/ExifInterface;->doExifStreamIO(Ljava/io/InputStream;Ljava/io/OutputStream;)V
    ...
    invoke-static {p2, v5}, Lcom/miui/gallery/util/BaseDocumentProviderUtils;->getDocumentFile(Landroid/content/Context;Ljava/io/File;)Landroidx/documentfile/provider/DocumentFile;
    ...
    invoke-virtual {p2, p1, v5}, Landroid/content/ContentResolver;->openFileDescriptor(Landroid/net/Uri;Ljava/lang/String;)Landroid/os/ParcelFileDescriptor;

    move-result-object p1
    :try_end_2
    .catch Lcom/miui/gallery3d/exif/ExifInvalidFormatException; {:try_start_2 .. :try_end_2} :catch_8
    ...
    invoke-direct {p2, v5}, Ljava/io/FileOutputStream;-><init>(Ljava/io/FileDescriptor;)V
    :try_end_3
    .catch Lcom/miui/gallery3d/exif/ExifInvalidFormatException; {:try_start_3 .. :try_end_3} :catch_2
    ...
    :cond_0
    :try_start_4
    const-string p1, "failed to get document file"

    new-instance p2, Ljava/io/IOException;

    invoke-direct {p2, p1}, Ljava/io/IOException;-><init>(Ljava/lang/String;)V

    sget-object v0, Lcom/miui/gallery3d/exif/ExifInterface;->TAG:Ljava/lang/String;
    ...
    :try_end_4
    .catch Lcom/miui/gallery3d/exif/ExifInvalidFormatException; {:try_start_4 .. :try_end_4} :catch_8
    ...
    :goto_1
    :try_start_5
    new-instance v5, Lcom/miui/gallery3d/exif/ExifOutputStream;

    invoke-direct {v5, p2, p0}, Lcom/miui/gallery3d/exif/ExifOutputStream;-><init>(Ljava/io/OutputStream;Lcom/miui/gallery3d/exif/ExifInterface;)V

    iget-object v6, p0, Lcom/miui/gallery3d/exif/ExifInterface;->mData:Lcom/miui/gallery3d/exif/ExifData;

    invoke-virtual {v5, v6}, Lcom/miui/gallery3d/exif/ExifOutputStream;->setExifData(Lcom/miui/gallery3d/exif/ExifData;)V
    :try_end_5
    .catch Lcom/miui/gallery3d/exif/ExifInvalidFormatException; {:try_start_5 .. :try_end_5} :catch_6
    ...
    invoke-virtual {v5, v4, v0, v2}, Ljava/io/OutputStream;->write([BII)V

    invoke-virtual {v5}, Ljava/io/OutputStream;->flush()V
    :try_end_6
    .catch Lcom/miui/gallery3d/exif/ExifInvalidFormatException; {:try_start_6 .. :try_end_6} :catch_4
    .catch Ljava/io/IOException; {:try_start_6 .. :try_end_6} :catch_3
    .catchall {:try_start_6 .. :try_end_6} :catchall_1

    invoke-static {p2}, Lcom/miui/gallery3d/exif/ExifInterface;->closeSilently(Ljava/io/Closeable;)V
    ...
    invoke-static {p1}, Lcom/miui/gallery3d/exif/ExifInterface;->closeSilently(Ljava/io/Closeable;)V
    ...
    throw p1
    :try_end_7
    .catch Lcom/miui/gallery3d/exif/ExifInvalidFormatException; {:try_start_7 .. :try_end_7} :catch_8
...
.method public rewriteExif(Ljava/lang/String;Ljava/util/Collection;)Z
    ...
    :try_start_1
    invoke-static {p1, p0}, Lcom/miui/gallery3d/exif/ExifParser;->parse(Ljava/io/InputStream;Lcom/miui/gallery3d/exif/ExifInterface;)Lcom/miui/gallery3d/exif/ExifParser;
    ...
    :try_start_2
    invoke-virtual {v2}, Lcom/miui/gallery3d/exif/ExifParser;->getOffsetToExifEndFromSOF()I
    ...
    invoke-virtual {p0, v1, p2}, Lcom/miui/gallery3d/exif/ExifInterface;->rewriteExif(Ljava/nio/ByteBuffer;Ljava/util/Collection;)Z
...
.method public rewriteExif(Ljava/nio/ByteBuffer;Ljava/util/Collection;)Z
    ...
    :try_start_0
    new-instance v0, Lcom/miui/gallery3d/exif/ExifModifier;

    invoke-direct {v0, p1, p0}, Lcom/miui/gallery3d/exif/ExifModifier;-><init>(Ljava/nio/ByteBuffer;Lcom/miui/gallery3d/exif/ExifInterface;)V
    ...
    check-cast p2, Lcom/miui/gallery3d/exif/ExifTag;

    invoke-virtual {v0, p2}, Lcom/miui/gallery3d/exif/ExifModifier;->modifyTag(Lcom/miui/gallery3d/exif/ExifTag;)V
